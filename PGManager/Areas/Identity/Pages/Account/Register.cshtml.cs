...
namespace PGManager.Areas.Identity.Pages.Account
{
	[AllowAnonymous]
	public class RegisterModel : PageModel
	{
		...
		{
			if (_signInManager.IsSignedIn(User) && !User.IsInRole(SD.Role_Admin))
			...
			{
				RoleList = _roleManager.Roles.Where(u => u.Name != SD.Role_User_Customer).Select(x => x.Name).Select(i => new SelectListItem
				{
					Text = i,
					Value = i
				})
